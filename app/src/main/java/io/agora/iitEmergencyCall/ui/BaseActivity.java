...
import io.agora.iitEmergencyCall.AGApplication;
import io.agora.iitEmergencyCall.BuildConfig;
import io.agora.iitEmergencyCall.model.*;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    private boolean checkSelfPermissions() {
        return checkSelfPermission(Manifest.permission.RECORD_AUDIO, ConstantApp.PERMISSION_REQ_ID_RECORD_AUDIO) &&
                ...
                checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION, ConstantApp.PERMISSION_REQ_ID_LOCATION);
    }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            ...
            case ConstantApp.PERMISSION_REQ_ID_LOCATION: {
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
